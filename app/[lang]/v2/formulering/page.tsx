...
import { COPY } from "../../formulering/copy"

// V2-spåret: samma formuleringssida i theme-v2. Noindex — v1-sidan på
// /formulering är den publika.
export const metadata: Metadata = {
  title: "DYGN · Formuleringen · V2",
  robots: { index: false, follow: false },
}

export default async function V2FormulaPage({ params }: LangParams) {
